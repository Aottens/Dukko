...
# Organize the test source in the Benchmarks/ folder in the IDE
...
# Make an Xcode Scheme for the benchmarks executable so we can run them in the IDE
set_target_properties(Benchmarks PROPERTIES XCODE_GENERATE_SCHEME ON)

# When running Benchmarks we have specific needs
target_compile_definitions(Benchmarks PUBLIC
    JUCE_MODAL_LOOPS_PERMITTED=1 # let us run Message Manager in tests
    RUN_DUKKO_TESTS=1            # also run tests in module .cpp files guarded by RUN_DUKKO_TESTS
)
