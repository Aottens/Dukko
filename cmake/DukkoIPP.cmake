...
elseif(APPLE)
    ...
    # compile with DUKKO_IPP and link IPP libraries only for the x86_64 slice.
...
if (DEFINED IPP_ROOT)
    if (IS_DIRECTORY "${IPP_ROOT}")
        ...
        if (IPP_MACOS)
            ...
            target_compile_options(SharedCode INTERFACE "SHELL:-Xarch_x86_64 -DDUKKO_IPP=1")
            ...
            target_compile_definitions(SharedCode INTERFACE DUKKO_IPP=1)
        endif()
    else ()
